...
describe('CF-004 Terraform - REQ-01: default cache behavior with no viewer protocol policy', () => {
  it('flags a distribution whose default_cache_behavior has no viewer_protocol_policy', () => {
        ...
        default_cache_behavior: [
          {
            ...
            // viewer_protocol_policy intentionally omitted
          },
        ],
        origin: [
          {
