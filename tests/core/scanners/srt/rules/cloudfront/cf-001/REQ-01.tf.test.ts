...
describe('CF-001 Terraform - REQ-01: No viewer certificate configuration', () => {
  it('flags an aws_cloudfront_distribution that has no viewer_certificate block configured', () => {
    const resource: TerraformResource = {
      ...
      values: {
        ...
        // Note: No viewer_certificate block defined at all
      },
