...
import { Sec006Rule } from '../../../../../../src/assess/scanning/security-matrix/rules/secrets-management/006-customer-managed-keys.cf.js';
import { CloudFormationResource } from '../../../../../../src/assess/scanning/security-matrix/security-rule-base.js';

describe('Sec006Rule', () => {
  const rule = new Sec006Rule();
  const stackName = 'test-stack';

  describe('evaluate', () => {
    describe('AWS::SecretsManager::Secret', () => {
      it('should not return a finding if a secret has no KMS key ID', () => {
        // Arrange
      ...
      it('should return a finding if a secret uses an AWS-managed KMS key', () => {
        ...
        expect(result?.issue).toContain('Secret uses AWS managed KMS key instead of customer managed key');
      });
