...
import { s3002Control } from './s3-002/s3-002.control.js';
import { S3002CfnAdapterFactory } from './s3-002/s3-002.adapter.cfn.js';
import { S3002TfAdapterFactory } from './s3-002/s3-002.adapter.tf.js';
...
export const s3Controls: RegisteredControl[] = [
  ...
  { control: s3002Control, cfnAdapter: new S3002CfnAdapterFactory(), tfAdapter: new S3002TfAdapterFactory() },
];
