...
Before a rule evaluates a resource, the template passes through `parseCfnTemplate`. This function resolves intrinsic functions and pseudo-parameters in place. Understanding what values the rule will actually see is essential for writing correct fixtures.
